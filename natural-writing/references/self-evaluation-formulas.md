...
**Cost: O(K × N × V). Trigger only in the 40–60% uncertainty zone (Tier 1+2 combined)**
...
people, specific dates, real version numbers, acknowledged failures. This generates
